...
public final class FragmentLeaderboardWeightBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentLeaderboardWeightBinding(@NonNull LinearLayout rootView,
  ...
  @NonNull
  public static FragmentLeaderboardWeightBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentLeaderboardWeightBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_leaderboard_weight, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentLeaderboardWeightBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLeaderboardWeightBinding((LinearLayout) rootView, rvLeaderboard,
